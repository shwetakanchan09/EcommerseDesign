...
import com.shweta.reyound.activity.KurtaActivity;
import com.shweta.reyound.R;
import com.shweta.reyound.activity.AddBasketActivity;

public class KurtaAdapter extends BaseAdapter {
    private Context mContext;
    private final String[] web;
    private final int[] Imageid;

    public KurtaAdapter(KurtaActivity c, String[] web, int[] Imageid ) {
        mContext = c;
