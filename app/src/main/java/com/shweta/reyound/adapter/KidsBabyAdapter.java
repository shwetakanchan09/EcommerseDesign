...
import com.shweta.reyound.activity.JeansActivity;
import com.shweta.reyound.activity.KidsActivity;

public class KidsBabyAdapter extends BaseAdapter {
    private Context mContext;
    private final String[] web;
    private final int[] Imageid;

    public KidsBabyAdapter(KidsActivity c, String[] web, int[] Imageid ) {
        mContext = c;
...
//        if (convertView == null) {
            ...
            grid = inflater.inflate(R.layout.item_kids, null);
